...
public class CS401_K142268_A1P2 {
...
//	private static final String FILENAME = "D:\\A1-tc5.txt";
	...
	public static void main(String args[]){
		...
		try {
	        ...
	        System.setOut(out);
	        boolean pathExistsBreadth = breadthFirst(maze);
	        if(!pathExistsBreadth){
	...
	public static boolean breadthFirst(int[][] matrix) {
        ...
        while(!frontier.isEmpty()){
        	...
        	List<Node> neighbours = getNeighbours(frontier, matrix, current);
