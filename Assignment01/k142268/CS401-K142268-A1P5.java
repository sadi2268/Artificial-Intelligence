...
class Node {
	...
	public double heuristic(){
		Node goal = new Node(new State(CS401_K142268_A1P5.final_x, CS401_K142268_A1P5.final_y));
    	double g =
...
class NodeComparator implements Comparator<Node>
{
    ...
    public int compare(Node x, Node y)
    {
    	...
    	double g_x = x.heuristic();
    	double g_y = y.heuristic();
    	if(g_x>g_y)
    		return 1;
    	if(g_x<g_y)
    		return -1;
...
public class CS401_K142268_A1P5 {
...
//	private static final String FILENAME = "D:\\A1-tc6.txt";
	...
	public static void main(String args[]){
		...
		try {
	        ...
	        System.setOut(out);
	        boolean pathExistsGreedy = greedyFirst(maze);
	        if(!pathExistsGreedy){
